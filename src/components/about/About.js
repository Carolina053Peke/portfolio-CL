  ...
  <div className="s-about column">
    <div className="column large-3 tab-10">
      ...
      <div className="row s-about__content-bottom"  >
            <div className="row w-1000-stack">
              <a href="../Carolina_Lemes.pdf" type="application/pdf" download="../Carolina_Lemes.pdf" className="btn btn--download">
    ...
    <br />
      ...
      <br />
          <ul className="about-block" style={{color:'#ECF0F1',listStyle:'none', textAlign:'center', marginTop:'20px'}}>
            <li><i class="fas fa-code"></i>   Web development level I: HTML and CSS</li>
            <li><i class="far fa-file-code"></i>   Web Development level II: Introduction to the JavaScript language</li>
